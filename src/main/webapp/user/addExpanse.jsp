...
%>
	 <section class="flex justify-center bg-slate-900 items-center h-screen">
      <div class="bg-gray-800 text-white shadow-md rounded-md mt-2 p-8 max-w-lg w-full">
        <h1 class="text-3xl font-bold text-white mb-6 text-center">Add Expenses</h1>
        ...
        <form action="../addExpense" method ="post" class="space-y-4">
          <div>
            <label for="" class="font-semibold mb-2">Expense Name </label>
